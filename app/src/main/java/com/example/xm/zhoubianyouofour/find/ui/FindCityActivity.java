...
import com.example.xm.zhoubianyouofour.find.adapter.CityListAdapter;
import com.example.xm.zhoubianyouofour.find.entity.City;
import com.example.xm.zhoubianyouofour.find.entity.DataConstants;
import com.example.xm.zhoubianyouofour.find.utils.DividerDecoration;
...
public class FindCityActivity extends AppCompatActivity implements OnQuickSideBarTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.find_activity_city);
    ...
    private class CityListWithHeadersAdapter extends CityListAdapter<RecyclerView.ViewHolder>
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.find_city_view_item, parent, false);
        ...
        public RecyclerView.ViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.find_city_view_header, parent, false);
            return new RecyclerView.ViewHolder(view) {
            };
        }
